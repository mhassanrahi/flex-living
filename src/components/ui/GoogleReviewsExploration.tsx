      ...
      {isExpanded && (
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="font-semibold text-blue-900 mb-2">Integration Status: Exploration Phase</h4>
            <p className="text-blue-800 text-sm">
              Google Reviews integration is currently in the exploration phase. Here are the findings:
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-200 rounded-lg p-4">
              <h5 className="font-semibold text-gray-900 mb-2">✅ Feasible Options</h5>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <h5 className="font-semibold text-gray-900 mb-2">⚠️ Challenges</h5>
              <ul className="text-sm text-gray-600 space-y-1">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h5 className="font-semibold text-yellow-900 mb-2">💡 Recommendation</h5>
            <p className="text-yellow-800 text-sm">
              For the initial implementation, focus on the Hostaway integration. Google Reviews can be added as a future enhancement once the core system is stable and user feedback is gathered.
            </p>
          </div>
