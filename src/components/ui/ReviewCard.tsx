...
export default function ReviewCard({ review, onApprove, showApprovalControls = false }: ReviewCardProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="font-semibold text-lg text-gray-900">{review.guestName}</h3>
