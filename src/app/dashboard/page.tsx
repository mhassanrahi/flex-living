...
import { fetchReviews, filterReviews, calculateStats, getUniqueListings, getUniqueCategories } from '@/lib/reviews';
import ReviewCard from '@/components/ui/ReviewCard';
import StatsCard from '@/components/ui/StatsCard';
import ReviewFilters from '@/components/ui/ReviewFilters';
import GoogleReviewsExploration from '@/components/ui/GoogleReviewsExploration';
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">FlexLiving Reviews Dashboard</h1>
              <p className="text-gray-600 mt-1">Manage and analyze guest reviews across all properties</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {stats.topIssues.length > 0 && (
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 mb-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Top Issues to Address</h3>
