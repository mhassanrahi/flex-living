...
const mockReviews = [
  ...
  },
  {
    ...
    status: "published",
    rating: 4.5,
    publicReview: "Great location and clean apartment. The check-in process was smooth.",
    reviewCategory: [
  ...
  },
  {
    ...
    status: "published",
    rating: 3.0,
    publicReview: "The apartment was okay but could use some maintenance. The heating wasn't working properly.",
    reviewCategory: [
  ...
  },
  {
    ...
    status: "published",
    rating: 5.0,
    publicReview: "Absolutely perfect stay! The apartment exceeded our expectations. Will definitely book again.",
    reviewCategory: [
      { category: "cleanliness", rating: 5 },
  ...
  },
  {
    ...
    status: "published",
    rating: 4.0,
    publicReview: "Good experience overall. The apartment was clean and well-located. Minor issues with WiFi.",
    reviewCategory: [
      { category: "cleanliness", rating: 5 },
      { category: "communication", rating: 4 },
      { category: "location", rating: 5 },
