...
import { fetchReviews, filterReviews, getUniqueListings } from '@/lib/reviews';
...
export default function Properties() {
  ...
  useEffect(() => {
    const loadReviews = async () => {
      try {
        ...
        const approvedReviews = data.filter(review => review.approved !== false);
  ...
  const getPropertyStats = (propertyName: string) => {
    const propertyReviews = reviews.filter(review => review.listingName === propertyName);
    const validReviews = propertyReviews.filter(review => review.rating !== null);
    ...
    return {
      ...
      guestReviews: propertyReviews.filter(review => review.type === 'guest-to-host').length,
      hostReviews: propertyReviews.filter(review => review.type === 'host-to-guest').length
    };
  };
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <Link href="/" className="text-2xl font-bold text-blue-600">FlexLiving</Link>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Discover what our guests are saying about our properties</p>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    {stats.averageRating > 0 && (
                      <p className="text-sm text-yellow-600">★ {stats.averageRating} average</p>
                    )}
                  </button>
                );
              })}
        ...
        {selectedProperty && (
          <div className="mb-8">
            <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{selectedProperty}</h2>
              {(() => {
                ...
                return (
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600">{stats.guestReviews}</div>
                      <div className="text-sm text-gray-600">Guest Reviews</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-600">{stats.hostReviews}</div>
        ...
        <div className="bg-blue-600 rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-blue-100 mb-6">
            Experience the quality that our guests rave about. Book your stay today!
          </p>
